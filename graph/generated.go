...
func (ec *executionContext) _Video_author(ctx context.Context, field graphql.CollectedField, obj *model.Video) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOPerson2ᚖgithubᚗcomᚋhagios2ᚋsimpleᚑappᚋgraphᚋmodelᚐPerson(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOPerson2ᚖgithubᚗcomᚋhagios2ᚋsimpleᚑappᚋgraphᚋmodelᚐPerson(ctx context.Context, sel ast.SelectionSet, v *model.Person) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
